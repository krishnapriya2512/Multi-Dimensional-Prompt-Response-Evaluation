...
@st.cache_resource
def load_transformer_sentiment(model_name: str = "distilbert-base-uncased-finetuned-sst-2-english"):
    """Load transformer sentiment model from Hugging Face Hub."""
    try:
...
#----------------------------------------------
    ...
    with left_col:
        ...
        if run_transformer: 
            ...
            transformer_nlp = load_transformer_sentiment("distilbert-base-uncased-finetuned-sst-2-english")
